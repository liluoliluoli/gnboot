...
func (k *keyword) WithContext(ctx context.Context) IKeywordDo { return k.keywordDo.WithContext(ctx) }
...
func (k keywordDo) SelectByID(id int64) (result *model.Keyword, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM keyword WHERE id=? ")
...
func (k keywordDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IKeywordDo {
