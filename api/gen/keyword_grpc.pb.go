...
// All implementations should embed UnimplementedKeywordRemoteServiceServer
// for forward compatibility
type KeywordRemoteServiceServer interface {
	FindGenre(context.Context, *FindKeywordRequest) (*FindKeywordResp, error)
}

// UnimplementedKeywordRemoteServiceServer should be embedded to have forward compatible implementations.
