...
func RegisterGenreRemoteServiceHTTPServer(s *http.Server, srv GenreRemoteServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/genre/query/all", _GenreRemoteService_FindGenre0_HTTP_Handler(srv))
}

func _GenreRemoteService_FindGenre0_HTTP_Handler(srv GenreRemoteServiceHTTPServer) func(ctx http.Context) error {
