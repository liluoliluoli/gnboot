...
func NewGnbootService(task *worker.Worker, gnboot *biz.GnbootUseCase, movie *biz.MovieUseCase) *GnbootService {
	return &GnbootService{task: task, gnboot: gnboot, movie: movie}
}
