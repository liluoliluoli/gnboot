...
func RegisterKeywordRemoteServiceHTTPServer(s *http.Server, srv KeywordRemoteServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/keyword/query/all", _KeywordRemoteService_FindGenre2_HTTP_Handler(srv))
}

func _KeywordRemoteService_FindGenre2_HTTP_Handler(srv KeywordRemoteServiceHTTPServer) func(ctx http.Context) error {
