...
func (g genreDo) SelectByID(id int64) (result *model.Genre, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM genre WHERE id=? ")
...
func (g genreDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IGenreDo {
