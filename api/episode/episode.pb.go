...
type UpdateBoxIpsRequest struct {
	...
	BoxIps []*BoxIps `protobuf:"bytes,1,rep,name=boxIps,proto3" json:"boxIps,omitempty"`
}
...
func (x *UpdateBoxIpsRequest) GetBoxIps() []*BoxIps {
	if x != nil {
		return x.BoxIps
	}
	return nil
...
type BoxIps struct {
	...
	XiaoYaBoxIp   string `protobuf:"bytes,1,opt,name=xiaoYaBoxIp,proto3" json:"xiaoYaBoxIp,omitempty"`
	JellyfinBoxIp string `protobuf:"bytes,2,opt,name=jellyfinBoxIp,proto3" json:"jellyfinBoxIp,omitempty"`
}
...
func (x *BoxIps) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BoxIps) ProtoMessage() {}

func (x *BoxIps) ProtoReflect() protoreflect.Message {
	mi := &file_proto_episode_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BoxIps.ProtoReflect.Descriptor instead.
func (*BoxIps) Descriptor() ([]byte, []int) {
	return file_proto_episode_proto_rawDescGZIP(), []int{3}
}

func (x *BoxIps) GetXiaoYaBoxIp() string {
	if x != nil {
		return x.XiaoYaBoxIp
	}
	return ""
}

func (x *BoxIps) GetJellyfinBoxIp() string {
	if x != nil {
		return x.JellyfinBoxIp
	}
	return ""
}
...
var file_proto_episode_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x2f, 0x62, 0x6f, 0x78, 0x69, 0x70, 0x73, 0x2f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42,
...
var file_proto_episode_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_episode_proto_goTypes = []interface{}{
	...
	(*BoxIps)(nil),              // 3: gnboot.BoxIps
	(*subtitle.Subtitle)(nil),   // 4: gnboot.Subtitle
	(*emptypb.Empty)(nil),       // 5: google.protobuf.Empty
}
var file_proto_episode_proto_depIdxs = []int32{
	4, // 0: gnboot.Episode.subtitles:type_name -> gnboot.Subtitle
	3, // 1: gnboot.UpdateBoxIpsRequest.boxIps:type_name -> gnboot.BoxIps
	1, // 2: gnboot.EpisodeRemoteService.GetEpisode:input_type -> gnboot.GetEpisodeRequest
	2, // 3: gnboot.EpisodeRemoteService.UpdateBoxIps:input_type -> gnboot.UpdateBoxIpsRequest
	0, // 4: gnboot.EpisodeRemoteService.GetEpisode:output_type -> gnboot.Episode
	5, // 5: gnboot.EpisodeRemoteService.UpdateBoxIps:output_type -> google.protobuf.Empty
