...
func wireApp(c *conf.Bootstrap) (*kratos.App, func(), error) {
	...
	embyVideoTask := video.NewEmbyVideoTask(episodeRepo, videoRepo, universalClient, c, configRepo, actorRepo, videoActorMappingRepo, episodeSubtitleMappingRepo)
	episodeProvider := adaptor.NewEpisodeProvider(episodeService, userService, jfVideoTask, embyVideoTask)
