...
// Validate checks the field values on TestDoubanSyncTaskRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *TestDoubanSyncTaskRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on TestDoubanSyncTaskRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// TestDoubanSyncTaskRequestMultiError, or nil if none found.
func (m *TestDoubanSyncTaskRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *TestDoubanSyncTaskRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return TestDoubanSyncTaskRequestMultiError(errors)
	}

	return nil
}

// TestDoubanSyncTaskRequestMultiError is an error wrapping multiple validation
// errors returned by TestDoubanSyncTaskRequest.ValidateAll() if the
// designated constraints aren't met.
type TestDoubanSyncTaskRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m TestDoubanSyncTaskRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m TestDoubanSyncTaskRequestMultiError) AllErrors() []error { return m }

// TestDoubanSyncTaskRequestValidationError is the validation error returned by
// TestDoubanSyncTaskRequest.Validate if the designated constraints aren't met.
type TestDoubanSyncTaskRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e TestDoubanSyncTaskRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TestDoubanSyncTaskRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TestDoubanSyncTaskRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TestDoubanSyncTaskRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TestDoubanSyncTaskRequestValidationError) ErrorName() string {
	return "TestDoubanSyncTaskRequestValidationError"
}

// Error satisfies the builtin error interface
func (e TestDoubanSyncTaskRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sTestDoubanSyncTaskRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = TestDoubanSyncTaskRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = TestDoubanSyncTaskRequestValidationError{}
