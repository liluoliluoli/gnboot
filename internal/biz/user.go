...
type UserRepo interface {
	Create(ctx context.Context, item *CreateUser) error
...
func (uc *UserUseCase) Create(ctx context.Context, item *CreateUser) error {
...
func (uc *UserUseCase) get(ctx context.Context, action string, id uint64) (res string, err error) {
