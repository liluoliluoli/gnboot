...
func (a *actor) WithContext(ctx context.Context) IActorDo { return a.actorDo.WithContext(ctx) }
...
func (a actorDo) SelectByID(id int64) (result *model.Actor, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM actor WHERE id=? ")
